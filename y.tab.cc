...
{
       0,    38,    38,    41,    42,    45,    48,    51,    54,    59,
      64,    65,    69,    74,    80,    81,    84,    87,    91,    92,
      96,   100,   104,   110,   118,   127
};
#endif
...
static const char *const yytname[] =
{
  ...
  "background_opt", "iomodifier_list", "iomodifier_opt", YY_NULLPTR
};
...
static const yytype_int8 yypact[] =
{
      10,    -2,    -6,    -6,     1,     9,    -6,    -6,    -6,    -6,
       5,    -6,    -6,    -6,    14,    15,    -5,    -6,    -6,    -6,
      16,    17,    18,    -6,    19,    20,    21,    22,    -6,    -6,
      -6,    -6,    -6,    -6,    -6,    -6
};
...
static const yytype_int8 yydefact[] =
{
      ...
      19,     8,     1,     4,     9,     0,    17,    12,    10,    14,
       0,     0,     0,    16,     0,     0,     0,     0,    18,    20,
      21,    22,    23,    24,    25,     6
};
...
static const yytype_int8 yystos[] =
{
      ...
      23,     6,     0,    17,    20,     9,    25,     3,    21,    19,
       5,     7,     8,    10,    11,    12,    13,    24,    26,     3,
       3,     3,     3,     3,     3,     6
};
...
#line 1153 "y.tab.cc"
  ...
  case 16: /* background_opt: AMPERSAND  */
#line 84 "shell.y"
                  { 
...
#line 96 "shell.y"
                   { // redirect output
		if (Shell::_currentCommand._outFile == NULL) Shell::_currentCommand._outFile = (yyvsp[0].cpp_string);
...
#line 100 "shell.y"
                    { // redirect input to word
		if (Shell::_currentCommand._inFile == NULL) Shell::_currentCommand._inFile = (yyvsp[0].cpp_string);
		else printf("Ambiguous output redirect.\n");
  	}
#line 1179 "y.tab.cc"
    break;
...
#line 110 "shell.y"
                              { // redirect output and error to word
...
#line 118 "shell.y"
                                   { // redirect output and error to word and append
		if (Shell::_currentCommand._outFile != NULL || Shell::_currentCommand._errFile != NULL) {
			printf("Ambiguous output redirect.\n");
		} else {
			Shell::_currentCommand._outFile = new std::string((yyvsp[0].cpp_string)->c_str());
...
#line 1217 "y.tab.cc"
  ...
  case 25: /* iomodifier_opt: TWOGREAT WORD  */
#line 127 "shell.y"
                        { // redirect error to word
		if (Shell::_currentCommand._errFile == NULL) Shell::_currentCommand._errFile = (yyvsp[0].cpp_string);
		else printf("Ambiguous output redirect.\n");
  	}
#line 1226 "y.tab.cc"
    break;
